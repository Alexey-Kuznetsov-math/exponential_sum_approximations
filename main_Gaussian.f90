...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~			
	...
	integer, parameter	:: n_infinity=2
	real, parameter		:: A=8.0
	real, parameter		:: B=14.5	
	logical, parameter	:: explicit_Laplace_transform=.false.
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~		
	integer, parameter	:: p=2*M-n_infinity 
! Nt = the number of discretization points for computing F(z_j) via double exponential quadrature	
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	open(1,file='c_24.txt')
	open(2,file='lambda_24.txt')
		do j=1,M
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    
	...
	do j=0,n
		if (mod(j,2).eq.0) then	  	
	  		f1(j)=(-one)**(j/2)*exp(log_factorial(j)-log_factorial(j/2))  
	 	end if
	end do
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	end function f_derivatives
!#######################################################################
	function log_factorial(n) result(f_result)
! this function returns log(n!)	
	implicit none
	integer, intent(in)		:: n
	type(mp_real)			:: f_result
	integer				:: k
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	f_result=zero
	if (n>=2) then
		do k=2,n
			f_result=f_result+log((k*one))
		end do	
	end if
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
! when the Laplace transform of f is not known explicitly, and the parameter 
! explicit_Laplace_transform is set to .false.,  this function is never used
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~	
	implicit none
